...
function createTable(data){
    ...
    data.forEach(function (fulltbp,index) {
        ...
        <td style="text-align:center">${code}</td>                                                        
            ...
            <td> 
                <a href="${route.url}/dashboard/admin/search/company/profile/${fulltbp.minitbp.businessplan.company['id']}" class="text-info" target="_blank">${fulltbp.minitbp.businessplan.company['fullname']} </a> 
            </td> 
        </tr>`
        });
