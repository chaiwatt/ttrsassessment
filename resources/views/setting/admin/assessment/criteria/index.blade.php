    ...
    <div class="page-header page-header-light">
        ...
        <div class="page-header-content header-elements-md-inline">
            <div class="page-title d-flex">
                <h4> <span class="font-weight-semibold">รายการ Criteria</span></h4>
                <a href="#" class="header-elements-toggle text-default d-md-none"><i class="icon-more"></i></a>
            </div>
            <div class="header-elements d-none">
                <a href="{{route('setting.admin.assessment.criteria.create')}}" class="btn btn-labeled btn-labeled-right bg-info">เพิ่ม Criteria<b><i class="icon-plus3"></i></b></a>
            </div>
        </div>
        ...
        <div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
            <div class="d-flex">
                <div class="breadcrumb">
                    ...
                    <span class="breadcrumb-item active">Criteria</span>
                </div>
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header header-elements-sm-inline">
                        <h6 class="card-title" style="font-size:16px;font-weight: bold">Criteria</h6>
            ...
            buttons: [
                    { 
                        ...
                        customize: function( xlsx ) {
                            ...
                            source.setAttribute('name','Criteria');
                        }, 
                    }        
                ],
