    ...
    <div class="page-header page-header-light">
        ...
        <div class="page-header-content header-elements-md-inline">
            <div class="page-title d-flex">
                <h4> <span class="font-weight-semibold">เพิ่ม EV Template</span></h4>
                        ...
                        <form method="POST" action="{{route('setting.admin.assessment.ev.createsave')}}" enctype="multipart/form-data">
                            ...
                            <fieldset>	
                                <div class="form-group">
                                    <label>ชื่อ EV</label>
                                    <input type="text"  name="name" value="{{old('name')}}"  placeholder="ชื่อ EV" class="form-control form-control-lg">
                                </div>
                                <div class="form-group">
