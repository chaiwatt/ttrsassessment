    ...
    <div class="page-header page-header-light">
        ...
        <div class="page-header-content header-elements-md-inline">
            <div class="page-title d-flex">
                <h4> <span class="font-weight-semibold">{{$ev->name}}</span></h4>
                        ...
                        <form method="POST" action="{{route('setting.admin.assessment.ev.editsave',['id' => $ev->id])}}" enctype="multipart/form-data">
                            ...
                            <fieldset>	
                                <div class="form-group">
                                    <label>ชื่อ EV</label>
                                    <input type="text"  name="name" value="{{$ev->name}}"  placeholder="ชื่อ EV เช่น ttrs.01" class="form-control form-control-lg">
                                </div>
                                <div class="form-group">
                                    <label>เวอร์ชั่น</label>
                                    <input type="text" name="version" value="{{$ev->version}}"  placeholder="เวอร์ชั่น" class="form-control form-control-lg">
                                </div>
