    ...
    <div class="page-header page-header-light">
        ...
        <div class="page-header-content header-elements-md-inline">
            ...
            <div class="header-elements d-none">
                <a href="{{route('setting.admin.dashboard.religion.create')}}" class="btn btn-labeled btn-labeled-right bg-info">เพิ่มศาสนา <b><i class="icon-plus3"></i></b></a>
            </div>
        </div>
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header header-elements-sm-inline">
                        <h6 class="card-title" style="font-size:16px;font-weight: bold">ศาสนา</h6>
