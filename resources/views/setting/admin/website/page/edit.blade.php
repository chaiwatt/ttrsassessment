                                                            ...
                                                            <div class="col-sm-6 col-xl-6">
                                                                <div class="card">
                                                                    <div class="card-img-actions mx-1 mt-1">
                                                                        @if (Empty($page->feature_image_id))
                                                                            <img id="featureimage" class="card-img img-fluid" src="{{asset('assets/landing2/images/default.png')}}" alt="">
                                                                            @else
                                ...
                                <div class="row"> 
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text"  name="publicdate" value="{{$page->publicdateth}}" id="publicdate" placeholder="กำหนดวันแสดง" class="form-control form-control-lg" required>
                                        </div>
                                    </div>
                                </div>
