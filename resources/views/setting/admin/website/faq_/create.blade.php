    ...
    <div class="page-header page-header-light">
        <div class="page-header-content header-elements-md-inline">
            <div class="page-title d-flex">
                <h4> <span class="font-weight-semibold">เพิ่มคำถามที่พบบ่อย</span></h4>
                                ...
                                <div class="col-md-12">
                                    <fieldset>	
                                        ...
                                        <div class="form-group">
											...
											<textarea name="body" class="form-control mb-3 stringformat600" rows="7" cols="1" placeholder="คำตอบภาษาไทย"></textarea>
                                        </div>      
                                        <div class="form-group">
                                            <label>คำตอบภาษาอังกฤษ<span class="text-danger">*</span></label>
											<textarea name="bodyeng" class="form-control mb-3 stringformat600" rows="7" cols="1" placeholder="คำตอบภาษาอังกฤษ"></textarea>
                                        </div>                           
                                        <div class="form-group">
