                            ...
                            <table class="table table-striped" id="testtopictable">
                                ...
                                <tbody>
                                    ...
                                    <tr>    
                                        ...
                                        <td> 
                                            <a href="{{route('setting.admin.website.pagestatus.edit',['id' => $pagestatus->id])}}" class=" badge bg-primary">แก้ไข</a>
                                            <a href="{{route('setting.admin.website.pagestatus.delete',['id' => $pagestatus->id])}}" data-name="" onclick="confirmation(event)" class=" badge bg-danger">ลบ</a>                                       
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
