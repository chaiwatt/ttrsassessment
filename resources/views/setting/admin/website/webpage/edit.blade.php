    ...
    <div class="content">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        <form method="POST" action="{{route('setting.admin.website.webpage.editsave',['id' => $page->id])}}" enctype="multipart/form-data">
                            @csrf
                            <div class="row">	
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label>ชื่อเรื่อง<span class="text-danger">*</span></label>
                                        <input type="text" name="title" value="{{$page->name}}"  placeholder="ชื่อเรื่อง" class="form-control form-control-lg stringformat60" required>
                                    </div>
                                    <div class="form-group">
                                        <div class="form-group">
                                            <label>รายละเอียด<span class="text-danger">*</span></label>
                                            <textarea name="body" id="body" class="form-control mb-3" rows="10" cols="1" placeholder="รายละเอียด" style="font-size: 16px" required>{{$page->body}}</textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <select name="status" id="status" placeholder="สถานะการแสดง" class="form-control form-control-select2">
                                                <option value="0" @if ($page->status == 0) selected  @endif >ไม่แสดง</option>
                                                <option value="1" @if ($page->status == 1) selected  @endif >แสดง</option>
                                        </select>
                                    </div>
                                </div>
