        ...
        <div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
            <div class="d-flex">
                <div class="breadcrumb">
                    ...
                    <a href="{{route('setting.website.slide')}}" class="breadcrumb-item"> ภาพสไลด์</a>
    ...
    <div class="content">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        <form method="POST" action="{{route('setting.website.slide.createsave')}}" enctype="multipart/form-data">
                            @csrf
                            <div class="row">	
                                <div class="col-md-12">
                                    <fieldset>	
                                        ...
                                        <div class="form-group">
                                            <label>ข้อความที่1<span class="text-danger">*</span></label>
                                            <input type="text"  name="textone" value="{{old('textone')}}"  placeholder="ข้อความที่1" class="form-control">
                                        </div>
                                        <div class="form-group">
                                            <label>ข้อความที่3<span class="text-danger">*</span></label>
