                            ...
                            <table class="table table-striped" id="testtopictable">
                                ...
                                <tbody>
                                    ...
                                    <tr>    
                                        ...
                                        <td> {{$tag->name}} </td>                                         
                                        <td> 
                                            <a href="{{route('setting.website.tag.edit',['id' => $tag->id])}}" class=" badge bg-primary">แก้ไข</a>
                                            <a href="{{route('setting.website.tag.delete',['id' => $tag->id])}}" data-name="" onclick="confirmation(event)" class=" badge bg-danger">ลบ</a>                                       
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
