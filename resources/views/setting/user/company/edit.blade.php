                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-md-12">	
                            ...
                            <input type="file" style="display:none;" id="companydoc" data-id="{{$company->id}}" name="companydoc" accept="image/jpeg,image/gif,image/png,application/pdf"/>
                        </div>
                    </div>
                </div>           
    ...
    <div class="page-header page-header-light">
        <div class="page-header-content header-elements-md-inline">
            <div class="page-title d-flex">
                <h4> <span class="font-weight-semibold">ข้อมูลสถานประกอบการ</span></h4>
