                    ...
                    <div class="card-body">
                        <form action="{{route('dashboard.admin.realtimereport.getexpert')}}" method="get">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    {{-- @if ( Request::get('search') != '' || Request::get('expertbranch') != 0 || Request::get('educationlevel') != 0) --}}
                                        ...
                                        <tbody >
                                            @foreach ($expertdetails as $expert)
                                                <tr>
                                                    ...
                                                    <td style="text-align: center">{{$expert->expereinceyear}} ปี {{$expert->expereincemonth}} เดือน</td>
                                                    <td style="text-align: center"> 
                                                        
                                                        
                                                        @if ($expert->user->company->saveprofile != 0)
