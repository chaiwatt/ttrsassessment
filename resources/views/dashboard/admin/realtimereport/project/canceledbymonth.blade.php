    ...
    <div class="page-header page-header-light">
        ...
        <div class="page-header-content header-elements-md-inline">
            <div class="page-title d-flex">
                <h4> <span class="font-weight-semibold">โครงการที่ขอยกเลิกรายเดือน</span></h4>
        ...
        <div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
            <div class="d-flex">
                <div class="breadcrumb">
                    ...
                    <span class="breadcrumb-item active">โครงการที่ขอยกเลิกรายเดือน</span>
                </div>
            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-header header-elements-sm-inline">
                        <h6 class="card-title" style="font-size:16px;font-weight: bold">โครงการที่ขอยกเลิกรายเดือน</h6>
                    ...
                    <div class="card-body">
                        <form action="{{route('dashboard.admin.realtimereport.project.getcanceledbymonth')}}" method="get">
                            @csrf
                            <div class="row">
                                <div class="col-md-6">
                                            ...
                                            @foreach ($fulltbps as $fulltbp)
                                                @if ($fulltbp->minitbp->businessplan->business_plan_status_id >2)
                                                    <tr>
                                                        ...
                                                        <td style="text-align: center">{{$fulltbp->cancelmonth}}</td>
