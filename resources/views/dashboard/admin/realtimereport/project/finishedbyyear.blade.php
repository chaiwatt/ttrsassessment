    ...
    <div class="page-header page-header-light">
        ...
        <div class="page-header-content header-elements-md-inline">
            <div class="page-title d-flex">
                <h4> <span class="font-weight-semibold">โครงการที่ประเมินแล้วเสร็จรายปี</span></h4>
        ...
        <div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
            <div class="d-flex">
                <div class="breadcrumb">
                    ...
                    <span class="breadcrumb-item active">โครงการที่ประเมินแล้วเสร็จรายปี</span>
                </div>
            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-header header-elements-sm-inline">
                        <h6 class="card-title" style="font-size:16px;font-weight: bold">โครงการที่ประเมินแล้วเสร็จรายปี</h6>
                    ...
                    <div class="card-body">
                        <form action="{{route('dashboard.admin.realtimereport.project.getfinishedbyyear')}}" method="get">
                            @csrf
                            <div class="row">
                                <div class="col-md-12">
                                ...
                                <div class="col-md-12">
                                    <button type="submit" name="btnsubmit" value="excel" class="btn btn-sm bg-teal float-right ml-1" @if (count($years) == 0 ) disabled @endif>Excel</button>  
                                    <button type="submit" name="btnsubmit" value="search" class="btn btn-sm bg-teal float-right" @if (count($years) == 0 ) disabled @endif>ค้นหา</button>  
                                </div>
                            </div>
                        </form>
                        <hr>
                                    ...
                                    <table class="table table-bordered table-striped mb-2" id="searchtable">
                                        <thead>
                                            <tr class="bg-info">
                                                ...
                                                <th style="text-align: center;width:1%;white-space: nowrap">วันที่ประเมินเสร็จ</th> 
                                            ...
                                            @foreach ($fulltbps as $fulltbp)
                                                @if ($fulltbp->minitbp->businessplan->business_plan_status_id >2)
                                                    <tr>
                                                        ...
                                                        <td style="text-align: center">{{$fulltbp->finishdateth}}</td>
                                                        ...
                                                        <td style="text-align: center">{{$fulltbp->finishyear}}</td>
                                                    </tr>
                                                @endif
                                            @endforeach
                                        </tbody>
