    ...
    <div class="page-header page-header-light">
        ...
        <div class="page-header-content header-elements-md-inline">
            <div class="page-title d-flex">
                <h4> <span class="font-weight-semibold">โครงการตามประเภทอุตสาหกรรมในแต่ละภูมิภาค</span></h4>
        ...
        <div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
            <div class="d-flex">
                <div class="breadcrumb">
                    ...
                    <span class="breadcrumb-item active">โครงการตามประเภทอุตสาหกรรมในแต่ละภูมิภาค</span>
                </div>
            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-header header-elements-sm-inline">
                        <h6 class="card-title" style="font-size:16px;font-weight: bold">โครงการตามประเภทอุตสาหกรรมในแต่ละภูมิภาค</h6>
                    ...
                    <div class="card-body">
                        <form action="{{route('dashboard.admin.realtimereport.project.getprojectindustrygroupbysector')}}" method="get">
                            @csrf
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <table class="table table-bordered table-striped mb-2" id="searchtable">
                                        <thead>
                                            <tr class="bg-info">
                                                ...
                                                <th style="text-align: center">ประเภทอุตสาหกรรม</th> 
