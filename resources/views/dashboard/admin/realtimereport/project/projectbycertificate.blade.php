    ...
    <div class="page-header page-header-light">
        ...
        <div class="page-header-content header-elements-md-inline">
            <div class="page-title d-flex">
                <h4> <span class="font-weight-semibold">จำนวนโครงการแยกตามที่ได้รับใบรับรอง</span></h4>
        ...
        <div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
            <div class="d-flex">
                <div class="breadcrumb">
                    ...
                    <span class="breadcrumb-item active">จำนวนโครงการแยกตามที่ได้รับใบรับรอง</span>
                </div>
            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-header header-elements-sm-inline">
                        <h6 class="card-title" style="font-size:16px;font-weight: bold">จำนวนโครงการแยกตามที่ได้รับใบรับรอง</h6>
                    ...
                    <div class="card-body">
                        <form action="{{route('dashboard.admin.realtimereport.project.getprojectbycertificate')}}" method="get">
                            @csrf
                            <div class="row">
                                <div class="col-md-12">
									<div class="form-group">
										<label>เลือกสถานะการได้รับใบรับรอง</label>
										<select name="status" data-placeholder="เลือกสถานะการได้รับใบรับรอง " value="{{old('status')}}"  class="form-control form-control-lg form-control-select2">
                                            <option value="1" @if (1 == Request::get('status')) selected @endif >ได้รับใบรับรองแล้ว</option> 
                                            <option value="2" @if (2 == Request::get('status')) selected @endif >ยังไม่ได้รับใบรับรอง</option> 
										</select>
									</div>
								</div>
                                <div class="col-md-12">
