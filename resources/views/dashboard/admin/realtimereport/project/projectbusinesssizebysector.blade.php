    ...
    <div class="page-header page-header-light">
        ...
        <div class="page-header-content header-elements-md-inline">
            <div class="page-title d-flex">
                <h4> <span class="font-weight-semibold">โครงการตามขนาดธุรกิจในแต่ละภูมิภาค</span></h4>
        ...
        <div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
            <div class="d-flex">
                <div class="breadcrumb">
                    ...
                    <span class="breadcrumb-item active">โครงการตามขนาดธุรกิจในแต่ละภูมิภาค</span>
                </div>
            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-header header-elements-sm-inline">
                        <h6 class="card-title" style="font-size:16px;font-weight: bold">โครงการตามขนาดธุรกิจในแต่ละภูมิภาค</h6>
                    ...
                    <div class="card-body">
                        <form action="{{route('dashboard.admin.realtimereport.project.getprojectbusinesssizebysector')}}" method="get">
                            @csrf
                            <div class="row">
                                <div class="col-md-6">
									<div class="form-group">
										<label>เลือกขนาดธุรกิจ</label>
										<select name="companysize" data-placeholder="เลือกขนาดธุรกิจ" value="{{old('companysize')}}"  class="form-control form-control-lg form-control-select2">
                                            <option value="0" > == เลือกทั้งหมด ==</option>
											@foreach ($companysizes as $companysize)
                                                <option value="{{$companysize->id}}" @if ($companysize->id == Request::get('companysize')) selected @endif >{{$companysize->name}}</option> 
											@endforeach
										</select>
									</div>
								</div>
                                <div class="col-md-6">
									<div class="form-group">
										<label>เลือกภูมิภาค</label>
										<select name="sector" data-placeholder="เลือกภูมิภาค" value="{{old('sector')}}"  class="form-control form-control-lg form-control-select2">
                                            <option value="0" > == เลือกทั้งหมด ==</option>
											@foreach ($sectors as $sector)
                                                <option value="{{$sector->id}}" @if ($sector->id == Request::get('sector')) selected @endif >{{$sector->name}}</option> 
											@endforeach
										</select>
									</div>
								</div>
                                    ...
                                    <table class="table table-bordered table-striped mb-2" id="searchtable">
                                        <thead>
                                            <tr class="bg-info">
                                                ...
                                                <th style="text-align: center">ขนาดธุรกิจ</th> 
                                        ...
                                        <tbody >
                                            @foreach ($fulltbps as $fulltbp)
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="text-align: center">{{$fulltbp->minitbp->businessplan->company->companysize}}</td>
                                                    <td >{{$fulltbp->projectprovincesectorname}}</td>
                                                </tr>
                                                @endif
                                            @endforeach
                                        </tbody>
