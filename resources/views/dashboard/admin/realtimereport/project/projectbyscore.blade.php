    ...
    <div class="page-header page-header-light">
        ...
        <div class="page-header-content header-elements-md-inline">
            <div class="page-title d-flex">
                <h4> <span class="font-weight-semibold">จำนวนโครงการแยกตามคะแนน</span></h4>
        ...
        <div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
            <div class="d-flex">
                <div class="breadcrumb">
                    ...
                    <span class="breadcrumb-item active">จำนวนโครงการแยกตามคะแนน</span>
                </div>
            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-header header-elements-sm-inline">
                        <h6 class="card-title" style="font-size:16px;font-weight: bold">จำนวนโครงการแยกตามคะแนน</h6>
                    ...
                    <div class="card-body">
                        <form action="{{route('dashboard.admin.realtimereport.project.getprojectbyscore')}}" method="get">
                            @csrf
                            <div class="row">
                                <div class="col-md-12">
									<div class="form-group">
										<label>เลือกคะแนน</label>
										<select name="score" data-placeholder="เลือกคะแนน " value="{{old('score')}}"  class="form-control form-control-lg form-control-select2">
											@foreach ($scores as $key => $score)
                                            <option value="{{$score->id}}" @if ($score->id == Request::get('score')) selected @endif >ช่วงคะแนน {{$score->min}} - {{$score->max}}</option> 
											@endforeach
										</select>
									</div>
								</div>
