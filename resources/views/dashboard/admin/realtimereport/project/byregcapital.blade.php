    ...
    <div class="page-header page-header-light">
        ...
        <div class="page-header-content header-elements-md-inline">
            <div class="page-title d-flex">
                <h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">โครงการตามทุนจดทะเบียน</span></h4>
        ...
        <div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
            <div class="d-flex">
                <div class="breadcrumb">
                    ...
                    <span class="breadcrumb-item active">ตามทุนจดทะเบียน</span>
                </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{route('dashboard.admin.realtimereport.project.getprojectbyregcapital')}}" method="get">
                            @csrf
                            <div class="row">
                                <div class="col-md-4">
                                ...
                                <div class="col-md-4">
									<div class="form-group">
										...
										<select name="regcapital" data-placeholder="ทุนจดทะเบียน" class="form-control form-control-lg form-control-select2">
											@foreach ($registeredcapitaltypes as $registeredcapitaltype)
                                                <option value="{{$registeredcapitaltype->id}}" @if ($registeredcapitaltype->id == Request::get('regcapital')) selected @endif >{{$registeredcapitaltype->detail}}</option> 
											@endforeach
										</select>
									</div>
								</div>
