    ...
    <div class="page-header page-header-light">
        ...
        <div class="page-header-content header-elements-md-inline">
            <div class="page-title d-flex">
                <h4> <span class="font-weight-semibold">จำนวนโครงการของ Expert แยกตามประเภทอุตสาหกรรม</span></h4>
        ...
        <div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
            <div class="d-flex">
                <div class="breadcrumb">
                    ...
                    <span class="breadcrumb-item active">จำนวนโครงการของ Expert แยกตามประเภทอุตสาหกรรม</span>
                </div>
            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-header header-elements-sm-inline">
                        <h6 class="card-title" style="font-size:16px;font-weight: bold">จำนวนโครงการของ Expert แยกตามประเภทอุตสาหกรรม</h6>
                    ...
                    <div class="card-body">
                        <form action="{{route('dashboard.admin.realtimereport.project.getprojectexpertbyindustrygroup')}}" method="get">
                            @csrf
                            <div class="row">
                                <div class="col-md-6">
									<div class="form-group">
										<label>เลือก Expert</label>
                                        @php
                                            $check = Request::get('expert');
                                            if(Empty($check)){
                                                $check = $firstexpert;
                                            }
                                        @endphp
										<select name="expert" data-placeholder="เลือก Expert" value="{{old('expert')}}"  class="form-control form-control-lg form-control-select2">
											@foreach ($experts as $expert)
                                                <option value="{{$expert->id}}" @if ($expert->id == $check) selected @endif >{{$expert->name}} {{$expert->lastname}}</option> 
											@endforeach
										</select>
									</div>
								</div>
