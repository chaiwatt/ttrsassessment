    ...
    <div class="page-header page-header-light">
        ...
        <div class="page-header-content header-elements-md-inline">
            <div class="page-title d-flex">
                <h4> <span class="font-weight-semibold">จำนวนโครงการแยกตามวัตถุประสงค์ของการประเมิน</span></h4>
        ...
        <div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
            <div class="d-flex">
                <div class="breadcrumb">
                    ...
                    <span class="breadcrumb-item active">จำนวนโครงการแยกตามวัตถุประสงค์ของการประเมิน</span>
                </div>
            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-header header-elements-sm-inline">
                        <h6 class="card-title" style="font-size:16px;font-weight: bold">จำนวนโครงการแยกตามวัตถุประสงค์ของการประเมิน</h6>
                    ...
                    <div class="card-body">
                        <form action="{{route('dashboard.admin.realtimereport.project.getprojectbyobjective')}}" method="get">
                            @csrf
                            <div class="row">
                                <div class="col-md-12">
									<div class="form-group">
										<label>เลือกวัตถุประสงค์ของการประเมิน</label>
										<select name="objecttivetype" data-placeholder="เลือกวัตถุประสงค์ของการประเมิน" value="{{old('objecttivetype')}}"  class="form-control form-control-lg form-control-select2">
                                            <option value="1" @if (1 == Request::get('objecttivetype')) selected @endif >สิทธิประโยชน์ทางการเงิน (Finance)</option> 
                                            <option value="2" @if (2 == Request::get('objecttivetype')) selected @endif >สิทธิประโยชน์ที่ไม่ใช่การเงิน (Non-Finance)</option> 
										</select>
									</div>
								</div>
                                <div class="col-md-12">
