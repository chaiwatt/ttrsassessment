    ...
    <div class="page-header page-header-light">
        ...
        <div class="page-header-content header-elements-md-inline">
            <div class="page-title d-flex">
                <h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">โครงการตามเกรด</span></h4>
        ...
        <div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
            <div class="d-flex">
                <div class="breadcrumb">
                    ...
                    <span class="breadcrumb-item active">ตามเกรด</span>
                </div>
                        ...
                        <form action="{{route('dashboard.admin.realtimereport.project.getprojectbygrade')}}" method="get">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
									<div class="form-group">
										<label>เกรด</label>
										<select name="grade" data-placeholder="เกรด" value="{{old('grade')}}"  class="form-control form-control-lg form-control-select2">
											@foreach ($grades as $grade)
												{{-- <option value="{{$grade->id}}" >{{$grade->name}}</option>  --}}
                                                <option value="{{$grade->id}}" @if ($grade->id == Request::get('grade')) selected @endif >{{$grade->name}}</option> 
											@endforeach
										</select>
									</div>
								</div>
