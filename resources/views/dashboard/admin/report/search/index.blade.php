                            ...
                            <table style="width: 100%" class="table table-bordered table-striped">
                                ...
                                <tbody id="reportsearch_wrapper">
                                    ...
                                    <tr>
                                        ...
                                        <td> 
                                            <a  href="{{route('dashboard.admin.search.company.profile',['id' => $fulltbp->minitbp->businessplan->company->id])}}" class="btn btn-sm bg-info">{{$fulltbp->minitbp->businessplan->company->fullname}} </a>
                                        </td>  
                                        <td>
