        ...
        <div class="wrapper">
            <div class="container" >
                ...
                <div class="box mt20 ml30">
                    ...
                    <div class="bw600"><strong>โครงการเลขที่ {{$thainumeric::toThaiNumeric($fulltbp->fulltbp_code)}} เรื่อง "{{$fulltbp->minitbp->project}}"</strong> ของ <strong>{{$fulltbp->minitbp->businessplan->company->fullname}}</strong></div>
