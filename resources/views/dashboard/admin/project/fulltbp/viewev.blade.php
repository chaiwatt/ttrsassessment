                                    ...
                                    <tr>    
                                        ...
                                        <td> 
                                            @if (Auth::user()->user_type_id == 4)
                                                    <a  href="{{route('dashboard.admin.project.fulltbp.editev',['id' => $ev->id])}}" class="btn btn-sm bg-info">แก้ไข Criteria</a>
                                                @elseif(Auth::user()->user_type_id == 5 || Auth::user()->user_type_id == 6)
                                                    <a  href="{{route('dashboard.admin.project.fulltbp.admin.editev',['id' => $ev->id])}}" class="btn btn-sm bg-info">แก้ไข Criteria</a>
                                            @endif
                                            
                                        </td>     
                                        <td> 
                                            <a  href="{{route('dashboard.admin.project.fulltbp.editev',['id' => $ev->id])}}" class="btn btn-sm bg-primary">แก้ไข</a>
                                            <a  href="{{route('dashboard.admin.project.fulltbp.deleteev',['id' => $ev->id])}}" data-name="" onclick="confirmation(event)" class="btn btn-sm bg-danger">ลบ</a>                                       
                                        </td>                             
                                    </tr>
                                    @endforeach
                                </tbody>
