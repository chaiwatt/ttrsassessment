    ...
    <div class="page-header page-header-light">
        ...
        <div class="page-header-content header-elements-md-inline">
            ...
            <div class="header-elements d-none">
                <a href="{{route('dashboard.setting.prefix.create')}}" class="btn btn-labeled btn-labeled-right bg-info">เพิ่มคำนำหน้า <b><i class="icon-plus3"></i></b></a>
            </div>
        </div>
                            ...
                            <table class="table table-striped" id="testtopictable">
                                ...
                                <tbody>
                                    ...
                                    <tr>    
                                        ...
                                        <td> {{$prefix->name}} </td>                                         
                                        <td> 
                                            <a href="{{route('dashboard.setting.prefix.edit',['id' => $prefix->id])}}" class=" badge bg-primary">แก้ไข</a>
