                                ...
                                <tbody>
                                    ...
                                    <tr>    
                                        ...
                                        <td style="text-align: right"> 
                                            ...
                                            @endif
                                            <a href="{{route('dashboard.company.assessment.minitbp.edit',['id' => $minitbp->id])}}" class=" btn btn-sm bg-warning">แก้ไข</a>
                                            
                                            @if (!Empty($minitbp->project))
                                                <a href="{{route('dashboard.company.assessment.minitbp.downloadpdf',['id' => $minitbp->id])}}" class=" btn btn-sm bg-teal">ดาวน์โหลด PDF</a>
                                                <a href="{{route('dashboard.company.assessment.minitbp.submit',['id' => $minitbp->id])}}" class=" btn btn-sm bg-info">ส่ง mini TBP</a>
                                            @endif
                                        </td>
                                    </tr>
                                    @endforeach
