                            ...
                            <table class="table table-striped" id="testtopictable">
                                ...
                                <tbody>
                                    ...
                                    <tr>    
                                        ...
                                        <td> 
                                            <a href="{{route('dashboard.company.assessment.fee.invoice',['id' => $businessplanfeetransaction->id])}}" class="btn btn-sm bg-primary">ใบแจ้งหนี้</a>
                                        </td>    
                                        <td> 
                                            <a href="{{route('dashboard.company.assessment.fee.payment',['id' => $businessplanfeetransaction->id])}}" class=" btn btn-sm bg-teal">แจ้งชำระเงิน</a>
                                        </td>                              
                                    </tr>
                                    @endforeach
                                </tbody>
