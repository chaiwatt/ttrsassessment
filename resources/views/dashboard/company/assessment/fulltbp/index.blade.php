                                ...
                                <tbody>
                                    ...
                                    <tr>    
                                        ...
                                        <td style="text-align: right"> 
                                            <a href="{{route('dashboard.company.assessment.fulltbp.edit',['id' => $fulltbp->id])}}" class=" btn btn-sm bg-warning">แก้ไข</a>
                                            <a href="{{route('dashboard.company.assessment.fulltbp.downloadpdf',['id' => $fulltbp->id])}}" class=" btn btn-sm bg-teal">ดาวน์โหลด PDF</a>
                                            <a href="{{route('dashboard.company.assessment.fulltbp.submit',['id' => $fulltbp->id])}}" class=" btn btn-sm bg-info">ส่ง Full TBP</a>
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
