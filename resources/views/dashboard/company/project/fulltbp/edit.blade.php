	...
	<div class="modal-dialog modal-dialog-scrollable">
		<div class="modal-content">
			...
			<div class="modal-footer">
				...
				<button id="btn_modal_add_employ" class="btn bg-primary" ><i class="icon-checkmark3 font-size-base mr-1"></i> เพิ่ม</button>
			</div>
		</div>
	</div>
</div>
...
<div id="modal_add_employ_projectmember" class="modal fade" style="overflow:hidden;">
	<div class="modal-dialog modal-dialog-scrollable">
		<div class="modal-content">
			...
			<div class="modal-footer">
				<button class="btn btn-link" data-dismiss="modal"><i class="icon-cross2 font-size-base mr-1"></i> ปิด</button>
				<button id="btn_modal_add_employ_projectmember" class="btn bg-primary" ><i class="icon-checkmark3 font-size-base mr-1"></i> เพิ่ม</button>
			</div>
		</div>
	</div>
</div>
...
<div id="modal_add_employeducation" class="modal fade" style="overflow:hidden;">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-footer">
				<button class="btn btn-link" data-dismiss="modal"><i class="icon-cross2 font-size-base mr-1"></i> ปิด</button>
				<button id="btn_modal_add_employeducation" class="btn bg-primary" ><i class="icon-checkmark3 font-size-base mr-1"></i> เพิ่ม</button>
			</div>
		</div>
	</div>
</div>
...
<div id="modal_add_employexperience" class="modal fade" style="overflow:hidden;">
	<div class="modal-dialog modal-dialog-scrollable">
		<div class="modal-content">
			...
			<div class="modal-footer">
				<button class="btn btn-link" data-dismiss="modal"><i class="icon-cross2 font-size-base mr-1"></i> ปิด</button>
				<button id="btn_modal_add_employexperience" class="btn bg-primary"><i class="icon-checkmark3 font-size-base mr-1"></i> เพิ่ม</button>
			</div>
		</div>
	</div>
</div>
...
<div id="modal_add_employtraining" class="modal fade" style="overflow:hidden;">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				<div class="row">
					...
					<div class="col-md-12">
						...
						<div class="form-group">
							<label>บริษัท</label><span class="text-danger">*</span>
							<input type="text" id="employtrainingowner" placeholder="บริษัท" class="form-control form-control-lg stringformat60">
						</div>
					</div>
				</div>
			</div>           
			<div class="modal-footer">
				<button class="btn btn-link" data-dismiss="modal"><i class="icon-cross2 font-size-base mr-1"></i> ปิด</button>
				<button id="btn_modal_add_employtraining" class="btn bg-primary"><i class="icon-checkmark3 font-size-base mr-1"></i> เพิ่ม</button>
			</div>
		</div>
	</div>
</div>
...
<div id="modal_add_stockholder" class="modal fade" style="overflow:hidden;">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-footer">
				<button class="btn btn-link" data-dismiss="modal"><i class="icon-cross2 font-size-base mr-1"></i> ปิด</button>
				<button id="btn_modal_add_stockholder" class="btn bg-primary" ><i class="icon-checkmark3 font-size-base mr-1"></i> เพิ่ม</button>
			</div>
		</div>
	</div>
</div>
...
<div id="modal_add_tectdevlevel" class="modal fade" style="overflow:hidden;">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-footer">
				<button class="btn btn-link" data-dismiss="modal"><i class="icon-cross2 font-size-base mr-1"></i> ปิด</button>
				<button id="btn_modal_add_tectdevlevel" data-id="{{$fulltbp->id}}" class="btn bg-primary" ><i class="icon-checkmark3 font-size-base mr-1"></i> เพิ่ม</button>
			</div>
		</div>
	</div>
</div>
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<div class="row">
					...
					<div class="col-md-12">	
						<div class="input-group">													
							<button class="btn btn-info  btn-icon ml-2 btn-sm float-left" type="button" onclick="document.getElementById('certify').click();" >อัปโหลด PDF</button>													
						</div>
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<div class="row">
					...
					<div class="col-md-12">	
						<div class="input-group">													
							<button class="btn btn-info  btn-icon ml-2 btn-sm float-left" type="button" onclick="document.getElementById('businessmodelcanvas').click();" >อัปโหลด PDF</button>													
						</div>
						<input type="file" style="display:none;"  data-id="{{$fulltbpprojectcertify->id}}" id="businessmodelcanvas" name="businessmodelcanvas" accept="application/pdf"/>
					</div>
				</div>
			</div>           
			<div class="modal-footer">
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<div class="row">
					...
					<div class="col-md-12">	
						<div class="input-group">													
							<button class="btn btn-info  btn-icon ml-2 btn-sm float-left" type="button" onclick="document.getElementById('swotfile').click();" >อัปโหลด PDF</button>													
						</div>
						<input type="file" style="display:none;"  data-id="{{$fulltbpprojectcertify->id}}" id="swotfile" name="swotfile" accept="application/pdf"/>
					</div>
				</div>
			</div>           
			<div class="modal-footer">
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<div class="row">
					...
					<div class="col-md-12">	
						<div class="input-group">													
							<button id="btnuploadcertify" class="btn btn-info  btn-icon ml-2 btn-sm float-left" type="button" onclick="document.getElementById('award').click();" >อัปโหลด PDF</button>													
						</div>
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<div class="row">
					...
					<div class="col-md-12">	
						<div class="input-group">													
							<button id="btnuploadstandard" class="btn btn-info  btn-icon ml-2 btn-sm float-left" type="button" onclick="document.getElementById('standard').click();" >อัปโหลด PDF</button>													
						</div>
	...
	<div id="modal_add_sell" class="modal fade" style="overflow:hidden;">
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-footer">
					<button class="btn btn-link" data-dismiss="modal"><i class="icon-cross2 font-size-base mr-1"></i> ปิด</button>
					<button id="btn_modal_add_sell" data-id="{{$fulltbp->id}}" class="btn bg-primary" ><i class="icon-checkmark3 font-size-base mr-1"></i> เพิ่ม</button>
				</div>
			</div>
		</div>
	</div>
	...
	<div id="modal_edit_sell" class="modal fade" style="overflow:hidden;">
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-footer">
					<button class="btn btn-link" data-dismiss="modal"><i class="icon-cross2 font-size-base mr-1"></i> ปิด</button>
					<button id="btn_modal_edit_sell" data-id="{{$fulltbp->id}}" class="btn bg-primary" ><i class="icon-checkmark3 font-size-base mr-1"></i> เพิ่ม</button>
				</div>
			</div>
		</div>
	</div>
	...
	<div id="modal_add_debtpartner" class="modal fade" style="overflow:hidden;">
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-footer">
					<button class="btn btn-link" data-dismiss="modal"><i class="icon-cross2 font-size-base mr-1"></i> ปิด</button>
					<button id="btn_modal_add_debtpartner" data-id="{{$fulltbp->id}}" class="btn bg-primary"><i class="icon-checkmark3 font-size-base mr-1"></i> เพิ่ม</button>
				</div>
			</div>
		</div>
	</div>
		...
		<div id="modal_edit_debtpartner" class="modal fade" style="overflow:hidden;">
			<div class="modal-dialog">
				<div class="modal-content">
					...
					<div class="modal-footer">
						<button class="btn btn-link" data-dismiss="modal"><i class="icon-cross2 font-size-base mr-1"></i> ปิด</button>
						<button id="btn_modal_edit_debtpartner" data-id="{{$fulltbp->id}}" class="btn bg-primary" ><i class="icon-checkmark3 font-size-base mr-1"></i> เพิ่ม</button>
					</div>
				</div>
			</div>
		</div>
	...
	<div id="modal_add_creditpartner" class="modal fade" style="overflow:hidden;">
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-footer">
					<button class="btn btn-link" data-dismiss="modal"><i class="icon-cross2 font-size-base mr-1"></i> ปิด</button>
					<button id="btn_modal_add_creditpartner" data-id="{{$fulltbp->id}}" class="btn bg-primary" ><i class="icon-checkmark3 font-size-base mr-1"></i> เพิ่ม</button>
				</div>
			</div>
		</div>
	</div>
	...
	<div id="modal_edit_creditpartner" class="modal fade" style="overflow:hidden;">
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-footer">
					<button class="btn btn-link" data-dismiss="modal"><i class="icon-cross2 font-size-base mr-1"></i> ปิด</button>
					<button id="btn_modal_edit_creditpartner" data-id="{{$fulltbp->id}}" class="btn bg-primary"><i class="icon-checkmark3 font-size-base mr-1"></i> เพิ่ม</button>
				</div>
			</div>
		</div>
	</div>
	...
	<div id="modal_edit_asset" class="modal fade" style="overflow:hidden;">
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-footer">
					<button class="btn btn-link" data-dismiss="modal"><i class="icon-cross2 font-size-base mr-1"></i> ปิด</button>
					<button id="btn_modal_edit_asset" data-id="{{$fulltbp->id}}" class="btn bg-primary" ><i class="icon-checkmark3 font-size-base mr-1"></i> แก้ไข</button>
				</div>
			</div>
		</div>
	</div>
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<div class="row">
					...
					<div class="col-md-12">	
						<div class="input-group">													
							<button class="btn btn-info  btn-icon ml-2 btn-sm float-left" type="button" onclick="document.getElementById('companygeneraldoc').click();" >อัปโหลด PDF</button>													
						</div>
						<input type="file" style="display:none;" data-id="{{$fulltbp->id}}" id="companygeneraldoc" name="companygeneraldoc" accept="application/pdf"/>
					</div>
				</div>
			</div>           
			<div class="modal-footer">
					...
					<input type="text" id="fulltbpid" value="{{$fulltbp->id}}" hidden>
						<form class="wizard-form steps-basic" action="#" data-fouc>
											...
											<div class="card card-body border-top-info-400">
												<div class="card-body">
													<div class="row">
														<div class="col-md-6">
															<div class="form-group">
																<label ><strong>1.1) ชื่อนิติบุคคล</strong></label>
														...
														<div class="col-md-6">
															<div class="form-group">
																<label><strong>1.2) ทะเบียนนิติบุคคลเลขที่</strong></label>
														...
														<div class="col-md-6">
															<div class="form-group">
																<label><strong>1.3) ปีที่จดทะเบียน</strong></label>
														...
														<div class="col-md-6">
															<div class="form-group">
																<label><strong>1.4) ทุนที่จดทะเบียน</strong></label>
														...
														<div class="col-md-6">
															<div class="form-group">
																<label><strong>1.5) ทุนจดทะเบียนที่เรียกชำระแล้ว</strong></label>
														...
														<div class="col-md-6">
															<div class="form-group">
																<label><strong>วันที่ชำระทุนจดทะเบียน</strong></label>
														...
														<div class="col-md-12">
															<div class="form-group">
																<label><strong>1.6) แผนผังองค์กร (Organization Chart) </strong>(ไฟล์ jpg, png ขนาด 600 x 400px ขนาดไม่เกิน 1 MB)</label>
														...
														<legend>
															<label for="" style="font-size: 16px"><strong>1.7) รายการบุคลากร</strong></label>
														</legend>
														<div class="col-md-12">
															<div class="row">
																<div class="col-md-3">
																	<div class="form-group">
																		...
																		<input type="text" name ="department_qty" id ="department_qty" value="{{$fulltbpemployee->department_qty}}" class="form-control form-control-lg numeralformat4" required >
																	</div>
																</div>
																<div class="col-md-3">
																	<div class="form-group">
																		<label>ผ่ายบริหาร</label>
																		<input type="text" name ="department1_qty"  id ="department1_qty" value="{{$fulltbpemployee->department1_qty}}" class="form-control form-control-lg numeralformat4" required>
																	</div>
																</div>
																<div class="col-md-3">
																	<div class="form-group">
																		<label>ฝ่ายวิจัยและพัฒนา</label>
																		<input type="text" name ="department2_qty" id ="department2_qty" value="{{$fulltbpemployee->department2_qty}}" class="form-control form-control-lg numeralformat4" required>
																	</div>
																</div>
																<div class="col-md-3">
																	<div class="form-group">
																...
																<div class="col-md-3">
																	<div class="form-group">
																		...
																		<input type="text" name ="department4_qty" id ="department4_qty" value="{{$fulltbpemployee->department4_qty}}" class="form-control form-control-lg numeralformat4" required>
																	</div>
																</div>
																<div class="col-md-3">
																	<div class="form-group">
																		<label>พนักงานทั่วไป</label>
																		<input type="text" name ="department5_qty" id ="department5_qty" value="{{$fulltbpemployee->department5_qty}}" class="form-control form-control-lg numeralformat4" required>
																	</div>
																</div>
															</div>
														</div>
														<div class="col-md-6">
															<div class="form-group">
																<label><strong>1.8) ประเภทธุรกิจ</strong></label>
														...
														<div class="col-md-12">
															...
															<div class="form-group">
																<label for="">รายละเอียด (การก่อตั้ง การเพิ่มทุน การเปลี่ยนแปลงชื่อบริษัท หรือการเปลี่ยนแปลงทางธุรกิจ ฯลฯ) <span id="companyhistoryerror" class="form-text text-danger" hidden >*กรุณากรอกรายละเอียด</span> </label>
														...
														<div class="col-md-12 mt-3">	
															<label for=""><strong>1.10 - 1.11) ข้อมูลผู้บริหารระดับสูง (CEO, CTO, CMO, CFO หรืออื่น ๆ โปรดระบุ)</strong><button type="button" class="btn btn-warning btn-icon ml-2 btn-sm hiddenelement"  id="btnaddboard"><i class="icon-add mr-2"></i>เพิ่ม</button></label>
															<div class="table-responsive">
																<table class="table table-striped table-bordered">
																	<thead>
																		<tr class="bg-info">
														...
														{{-- <div class="row"> --}}
															<div class="col-md-12 mt-3">	
																<label for=""><strong>1.12) บัญชีรายชื่อผู้ถือหุ้น</strong><button type="button" class="btn btn-warning btn-icon ml-2 btn-sm hiddenelement" id="btnstckholder" data-id="{{$company->id}}"><i class="icon-add mr-2"></i>เพิ่ม</button></label>
																<div class="table-responsive">
																	<table class="table table-striped table-bordered">
																		<thead>
																			<tr class="bg-info">
														...
														{{-- <div class="row"> --}}
															<div class="col-md-12 mt-3">	
																<label for=""><strong>1.13) ข้อมูลพนักงานด้านการนักวิจัย พัฒนา การผลิต และวิศวกรรม</strong><button type="button" class="btn btn-warning btn-icon ml-2 btn-sm hiddenelement" id="btnaddresearch"><i class="icon-add mr-2"></i>เพิ่ม</button></label>
																<div class="table-responsive">
																	<table class="table table-striped table-bordered">
																		<thead>
																			<tr class="bg-info">
														...
														{{-- <br>
															...
															<div class="col-md-12 mt-3">
																...
																<div class="form-group">
																	<label for=""><strong>1.14) ข้อมูลผู้รับผิดชอบหลักในโครงการ (ผู้จัดการโครงการ/หัวหน้าโครงการ)</strong> </label>
																</div>
															</div>
															<div class="col-md-6">
															...
															<div class="col-md-6">
																<div class="form-group">
																	<label>ชื่อ</label>
																	<input type="text" id="responsiblename" value="{{@$fulltbp->fulltbpresponsibleperson->name ?? Auth::user()->name}}" placeholder="ชื่อ" class="form-control form-control-lg stringformat20"  required>
																</div>
															</div>
															<div class="col-md-6">
																<div class="form-group">
																	<label>นามสกุล</label>
																	<input type="text" id="responsiblelastname" value="{{@$fulltbp->fulltbpresponsibleperson->lastname ?? Auth::user()->lastname}}" placeholder="นามสกุล" class="form-control form-control-lg stringformat20" required>
																</div>
															</div>
															<div class="col-md-6">
																<div class="form-group">
																	<label>อีเมล</label>
																	<input type="text" id="responsibleemail" value="{{@$fulltbp->fulltbpresponsibleperson->email ?? Auth::user()->email}}" placeholder="อีเมล" class="form-control form-control-lg stringformat30" required>
																</div>
															</div>
															<div class="col-md-6">
																<div class="form-group">
																	<label>ตำแหน่ง</label>
																	<input type="text" id="responsibleposition" value="{{@$fulltbp->fulltbpresponsibleperson->position ?? Auth::user()->position}}" placeholder="ตำแหน่ง" class="form-control form-control-lg stringformat20" required>
																</div>
															</div>
															<div class="col-md-6">
																<div class="form-group">
																	<label>โทรศัพท์</label>
																	<input type="text" id="responsiblephone" value="{{@$fulltbp->fulltbpresponsibleperson->phone1 ?? Auth::user()->phone}}" placeholder="เบอร์โทรศัพท์" class="form-control form-control-lg numeralformathphone" required>
																</div>
															</div>
															<div class="col-md-6">
																<div class="form-group">
																	<label>โทรศัพท์มือถือ</label>
																	<input type="text" id="responsibleworkphone" value="{{@$fulltbp->fulltbpresponsibleperson->phone2 ?? Auth::user()->phone}}" placeholder="โทรศัพท์มือถือ" class="form-control form-control-lg numeralformathphone" required>
																</div>
															</div>
															<div class="col-md-12">
																<div class="form-group">
													...
													<div class="card-body">
														<div class="row">
															...
															<div class="col-md-12">
																<div class="form-group">
																	<div class="form-group">
																		<label for=""><strong>2.3) บทคัดย่อโครงการ </strong></label> <span class="text-primary" id="projectabtracttextlength"></span>
																		<p>ควรประกอบด้วย 3 ย่อหน้า (1) ปัญหาหรือความต้องการของอุตสาหกรรมที่จะแก้ไข (Pain Point) (2) การแก้ปัญหาหรือตอบโจทย์ความต้องการของอุตสาหกรรมในโครงการ และ (3) ผลที่จะได้จากโครงการ รวมถึงผลกระทบเชิงเศรษฐกิจและสังคม</p>
																		
																		{{-- <input type="text" id="projectabtract_input" class="form-control form-control-lg projectabtractclass" > --}}
																		<textarea name="" id="projectabtract_input" class="form-control form-control-lg summernoteelement" cols="3" rows="5">{!!$fulltbp->abtract!!}</textarea>
																	</div>
															...
															<div class="col-md-12">
																<div class="form-group">
																	<label for=""><strong>2.4) ผลิตภัณฑ์หลัก (สินค้า/บริการ) ของโครงการ</strong> </label>
																	<p>อธิบายลักษณะของผลิตภัณฑ์หลัก (สินค้า/บริการ) ภายในโครงการ</p>
																	<textarea name="" id="mainproduct_input" class="form-control form-control-lg summernoteelement" cols="3" rows="5">{!!$fulltbp->mainproduct!!}</textarea>
															...
															<div class="col-md-12">
																<div class="form-group">
																	<label for=""><strong>2.5) จุดเด่นของผลิตภัณฑ์หลัก (สินค้าและบริการ) ของโครงการ</strong> </label> <span class="text-primary" id="productdetailstextlength"></span>
																	<p>อธิบายจุดเด่นหรือความแตกต่างของผลิตภัณฑ์หลัก (สินค้า/บริการ) ภายในโครงการ</p>
																	<textarea name="" id="productdetails_input" class="form-control form-control-lg summernoteelement" cols="3" rows="5">{!!$fulltbp->productdetail!!}</textarea>
															...
															<div class="col-md-12" >
																<div class="form-group">
																	<label for=""><strong>2.6.1) การพัฒนาเทคโนโลยี</strong></label> <span class="text-primary" id="projectechdevtextlength"></span>
															...
															<div class="col-md-12">
																<div class="form-group">
																	<label for="">อุปสรรค ความเสี่ยง และโอกาสในการพัฒนาด้านเทคโนโลยี (<i>เขียนอธิบายอุปสรรค ความเสี่ยง และโอกาสในการพัฒนาด้านเทคโนโลยี</i>)</label> <span class="text-primary" id="projectechdevproblemtextlength"></span>
															...
															<div class="col-md-12">
																...
																<div class="row">
																	...
																	<div class="col-md-12 mt-4">	
																		<div class="form-group">												
																			<label for="">เอกสารแนบสิทธิบัตรการประดิษฐ์/การออกแบบ/อนุสิทธิบัตร (ไฟล์ PDF ขนาดไม่เกิน 2 MB)<button type="button" class="btn btn-warning btn-icon ml-2 btn-sm hiddenelement" data-toggle="modal" data-target="#modal_add_certify"><i class="icon-add mr-2"></i>อัปโหลด</button></label>
																		</div>
																	</div>
															...
															<div class="col-md-12 mt-3">
																...
																<div class="form-group">												
																	<label for="">เอกสารแนบรางวัลด้านเทคโนโลยี/นวัตกรรมที่ได้รับ (ไฟล์ PDF ขนาดไม่เกิน 2 MB)<button type="button" class="btn btn-warning btn-icon ml-2 btn-sm hiddenelement" data-toggle="modal" data-target="#modal_add_award"><i class="icon-add mr-2"></i>อัปโหลด</button></label>
																</div>
															...
															<div class="col-md-12 mt-3">	
																<label for=""><strong>2.6.4) ใบรับรองมาตรฐานต่างๆ ที่ได้รับ ใบรับรองมาตรฐานต่างๆ ที่ได้รับ เช่น ISO, อย., มอก., GMP, HACCP, CMMI ฯลฯ</strong> </label><span class="text-primary" id="projectechdevproblemtextlength"></span>
																<div class="form-group">
																...
																<div class="form-group">												
																	...
																	<label for="">เอกสารใบรับรองมาตรฐานต่างๆ ที่ได้รับ (ไฟล์ PDF ขนาดไม่เกิน 2 MB)<button type="button" class="btn btn-warning btn-icon ml-2 btn-sm hiddenelement" data-toggle="modal" data-target="#modal_add_standard"><i class="icon-add mr-2"></i>อัปโหลด</button></label>
																...
																<div class="row">
																	...
																	<div class="col-md-6">	
																		<div class="form-group">
																			...
																			<input type="text" id="ganttnummonth" value="{{$fulltbpgantt->numofmonth}}" class="form-control form-control-lg numeralformat2">
																		</div>
																	</div>
																	<div class="col-md-12">	
																		<div class="form-group">	
												...
												<div class="card-body">
													...
													<div class="col-md-12">	
														<div class="form-group">
															...
															<textarea name="" id="modelcanvas" class="form-control form-control-lg summernoteelement" cols="3" rows="5">{!!@$fulltbp->fulltbpmarketbusinessmodelcanvas->detail!!}</textarea>
														</div>
														<div class="col-md-12">	
															<div class="input-group">													
																<label for="">เอกสารแนบ Business Model Canvas (ไฟล์ PDF ขนาดไม่เกิน 2 MB)<button type="button" class="btn btn-warning btn-icon ml-2 btn-sm hiddenelement" data-toggle="modal" data-target="#modal_add_bmc"><i class="icon-add mr-2"></i>อัปโหลด</button></label>
															</div>
														...
														<div class="col-md-12">	
															<div class="form-group">
																...
																<textarea name="" id="swot" class="form-control form-control-lg summernoteelement" cols="3" rows="5">{!!@$fulltbp->fulltbpmarketswot->detail!!}</textarea>
															</div>
															<div class="col-md-12">	
																<div class="input-group">													
																	
																	<label for="">SWOT Analysis, Five Forces Analysis (ไฟล์ PDF ขนาดไม่เกิน 2 MB)<button type="button" class="btn btn-warning btn-icon ml-2 btn-sm hiddenelement" data-toggle="modal" data-target="#modal_add_swot"><i class="icon-add mr-2"></i>อัปโหลด</button></label>
																</div>
							...
							<fieldset>	
								...
								<br>
							 <strong>ผู้ลงนามในแบบฟอร์มแผนธุรกิจเทคโนโลยี (Full TBP)</strong>	
								<div class="col-md-12 mt-2">
									<div class="form-group">
										<div class="table-responsive">
											<table class="table table-bordered table-striped">
												<thead>
													<tr class="bg-info">
														<th style="width:60%">เลือกผู้ลงนามในแบบฟอร์มแผนธุรกิจเทคโนโลยี (Full TBP)</th>
