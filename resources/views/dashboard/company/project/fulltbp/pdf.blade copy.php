...
<html lang="en">
    ...
    <body>
        ...
        <div class="wrapper">
            ...
            <div class="container" >
                ...
                <div class="box bw650 font14 mt20" >
                    ...
                    <div class="ml20 mt0">1.3 ปีที่จดทะเบียน : พ.ศ. {{Empty($fulltbp->minitbp->businessplan->company->registeredyear) ? '-' : $fulltbp->minitbp->businessplan->company->registeredyear}}</div>
                    <div class="ml20 mt0">1.4 ทุนจดทะเบียน : {{number_format($fulltbp->minitbp->businessplan->company->registeredcapital,2)}} บาท</div>
                    <div class="ml20 mt0">1.5 ทุนจดทะเบียนที่เรียกชำระแล้ว: : {{number_format($fulltbp->minitbp->businessplan->company->paidupcapital,2)}} บาท เมื่อวันที่:	{{Empty($fulltbp->minitbp->businessplan->company->paidupcapitaldate) ? '-' : $fulltbp->minitbp->businessplan->company->paidupcapitaldate}}</div>
                        ...
                        @if ($companyemploys->count() > 0)
                            @foreach ($companyemploys as $key => $companyemploy)
                                <div style="page-break-inside: avoid;">
                                    ...
                                    <div class="ml30 mt10"><strong><u>ลำดับที่ {{$key +1}}</u></strong></div>
                                    @endif
                                    <div class="ml30 mt0">ชื่อ-นามสกุลee : {{$companyemploy->prefix->name}}{{$companyemploy->name}} {{$companyemploy->lastname}}</div>
                ...
                <div style="page-break-inside: avoid;">
                    ...
                    <div class="ml30 mt20 font14"><strong>2.1 ชื่อโครงการ :</strong> {{$fulltbp->minitbp->project}}</div>
                </div>
                <div class="box bw650 font14" >
                ...
                <div class="landscape" style="width:980px">
                    ...
                    {{-- <div class="landscape"> --}}
                        <div class="ml20 mt20 font14"><strong>2.7 แผนการดำเนินงานโครงการ (Gantt Chart) </strong></div>
        ...
        <div class="box ml50 bw650 font14 mt20 " style="page-break-inside: avoid;">
        ...
        <div style="page-break-inside: avoid;">
            <div class="box ml50 bw650 font14 mt30 ">
                <div class="mt30"><strong><u>ข้อตกลง :</u></strong>
