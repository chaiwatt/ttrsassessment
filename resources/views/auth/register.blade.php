        ...
        <div class="card mb-0">
            <div class="card mb-0">
                ...
                <ul class="nav nav-tabs nav-justified alpha-grey " id="usertype" >
                    <li class="nav-item bg-info-300 registertab" style="margin-right:5px" value="1"><a href="#login-tab1" class="nav-link border-y-0 border-left-0 register active" style="height:100%" data-toggle="tab" ><h6 class="my-1"><span class="registertablaber">ผู้ขอรับการประเมิน</span></h6></a></li>
                    <li class="nav-item bg-teal-300 registertab" style="margin-right:5px" value="2"><a href="#login-tab2" class="nav-link border-y-0 border-left-0 register"  style="height:100%"  data-toggle="tab"><h6 class="my-1"><span class="registertablaber">เจ้าหน้าที่ TTRS</span></h6></a></li>
                    ...
                    <li class="nav-item bg-warning-300 registertab" style="margin-right:5px" value="3"><a href="#login-tab3" class="nav-link border-y-0 border-left-0 register"  style="height:100%"  data-toggle="tab"><h6 class="my-1"><span class="registertablaber">ผู้เชี่ยวชาญ</span></h6></a></li>
                </ul>
