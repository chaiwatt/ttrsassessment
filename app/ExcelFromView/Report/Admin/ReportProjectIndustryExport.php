...
class ReportProjectIndustryExport implements 
                                        ShouldAutoSize, 
                                        WithTitle, 
                                        FromArray,
                                        WithHeadings,
                                        WithEvents
{
    ...
    foreach ($years as $key => $year) {
        ...
        $projectindustries = array("year" => $year+543,"automotive" => $automotive, "smartelectronic" => $smartelectronic,"affluent" => $affluent,"agriculture" => $agriculture, "food" => $food,"robotic" => $robotic,"aviation" => $aviation, "biofuel" => $biofuel,"digital" => $digital,"medical" => $medical,"defense" => $defense,"education" => $education,"other" => $other);
