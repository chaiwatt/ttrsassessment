...
class ReportProjectExportExpertByIndustryGroup implements FromView,ShouldAutoSize,WithTitle
{
    protected $expert;
    protected $industrygroup;
    protected $projectname;
    function __construct($expert,$industrygroup) {
        $this->projectname = 'Expertแยกตามกลุ่มอุตสาหกรรม';
           $this->expert = $expert;
