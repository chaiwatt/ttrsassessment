...
class EditProfileExpertRequest extends FormRequest
{
    ...
    public function messages()
    {
      return  [
        ...
        // 'address1.required' => 'ยังไม่ได้กรอกที่อยู่ที่ติดต่อได้',
        // 'province1.required' => 'ยังไม่ได้เลือกจังหวัด',
        // 'amphur1.required' => 'ยังไม่ได้เลือกอำเภอ',
        // 'tambol1.required' => 'ยังไม่ได้เลือกตำบล',
        // 'postalcode1.required' => 'ยังไม่ได้กรอกรหัสไปรษณีย์',
        ...
        'inpexpertfield.required' => 'ยังไม่ได้เพิ่มความเชี่ยววชาญ',
      ]; 
    }
}
