...
class EditProfileRequest extends FormRequest
{
    ...
    public function messages()
    {
      return  [
            ...
            'registeredcapital.between' => 'ทุนจดทะเบียนต้องอยู่ในช่วง 1 - 100000000000000',
            'paidupcapital.required_if' => 'ยังไม่ได้กรอกทุนจดทะเบียนที่เรียกชำระแล้ว',
            'phone.required' => 'ยังไม่ได้กรอกเบอร์โทรศัพท์ที่ถูกต้อง',
            'phone.min' => 'เบอร์โทรศัพท์ไม่ถูกต้อง',
            'phone.max' => 'เบอร์โทรศัพท์ไม่ถูกต้อง',
