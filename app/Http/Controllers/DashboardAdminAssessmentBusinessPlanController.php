...
class DashboardAdminAssessmentBusinessPlanController extends Controller
{
    public function Index(){
        $businessplans = BusinessPlan::where('business_plan_active_status_id',1)
                                        ->where('business_plan_status_id',1)->get();
        return view('dashboard.admin.assessment.businessplan.index')->withBusinessplans($businessplans);
    }
    public function View($id){
        ...
        return view('dashboard.admin.assessment.businessplan.view')->withCompany($company)
