...
class DashboardCompanyAssessmentFeeController extends Controller
{
    public function Index(){
        ...
        return view('dashboard.company.assessment.fee.index')->withBusinessplanfeetransactions($businessplanfeetransactions);
    }
    ...
    public function Invoice($id)
    {
        ...
        $pdf = PDF::loadView('dashboard.company.assessment.fee.invoice', $data);
    ...
    public function Payment($id)
    {
        ...
        return view('dashboard.company.assessment.fee.payment')->withBusinessplanfeetransaction($businessplanfeetransaction)
