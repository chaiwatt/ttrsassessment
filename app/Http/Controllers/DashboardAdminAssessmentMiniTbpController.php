...
class DashboardAdminAssessmentMiniTbpController extends Controller
{
    public function Index(){
        ...
        return view('dashboard.admin.assessment.minitbp.index')->withMinitbps($minitbps);
    }
    ...
    public function View($id){
        ...
        return view('dashboard.admin.assessment.minitbp.view')->withMinitbp($minitbp)
                                                ->withBanks($banks)
    ...
    public function Approve($id){
        ...
        EmailBox::send($_user->email,'TTRS:กรอกข้อมูล Full TBP','เรียนผู้ประกอบการ<br> เอกสาร Mini TBP ของท่านได้รับอนุมัติแล้ว ให้สามารถกรอกข้อมูล Full TBP ได้ที่ <a href='.route('dashboard.company.assessment.fulltbp.edit',['id' => $minitbp->id]).'>คลิกที่นี่</a> <br>ด้วยความนับถือ<br>TTRS');
