...
class BusinessPlanController extends Controller
{
    public function Update(Request $request){
        ...
        if($request->status == 1){
            ...
            EmailBox::send($_user->email,'TTRS:กรอกข้อมูล Mini TBP','เรียนผู้ประกอบการ<br> คำขอประเมินธุรกิจของท่านได้รับอนุมัติให้สามารถกรอกข้อมูล Mini TBP ได้ที่ <a href='.route('dashboard.company.minitbp.edit',['id' => $minitbp->id]).'>คลิกที่นี่</a> <br>ด้วยความนับถือ<br>TTRS');
        }
